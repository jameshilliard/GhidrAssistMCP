...
/**
 * MCP tool for setting end-of-line comments.
 */
public class SetEOLCommentTool implements McpTool {

    @Override
    public String getName() {
        return "set_eol_comment";
    }

    @Override
    public String getDescription() {
        return "Set an end-of-line comment at an address";
    }
    ...
    public McpSchema.CallToolResult execute(Map<String, Object> arguments, Program currentProgram, GhidrAssistMCPPlugin plugin) {
        ...
        int transactionID = currentProgram.startTransaction("Set EOL comment");
        ...
        try {
            ...
            return McpSchema.CallToolResult.builder()
                .addTextContent(String.format("Successfully set EOL comment at %s", addr))
                .build();

        } catch (Exception e) {
            return McpSchema.CallToolResult.builder()
                .addTextContent("Failed to set EOL comment: " + e.getMessage())
                .build();
        } finally {
