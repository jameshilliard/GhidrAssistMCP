...
/**
 * MCP tool for creating bookmarks at addresses.
 */
public class CreateBookmarkTool implements McpTool {
    ...
    public String getDescription() {
        return "Create a bookmark at a specific address";
    }
    ...
    public McpSchema.JsonSchema getInputSchema() {
        return new McpSchema.JsonSchema("object",
            ...
            List.of("address", "type", "category"), null, null, null);
    }
    ...
    public McpSchema.CallToolResult execute(Map<String, Object> arguments, Program currentProgram, GhidrAssistMCPPlugin plugin) {
        ...
        if (type == null || type.isEmpty()) {
            return McpSchema.CallToolResult.builder()
                .addTextContent("type parameter is required (e.g., 'Analysis', 'Note', 'Info', 'Warning', 'Error')")
                .build();
        }
        ...
        int transactionID = currentProgram.startTransaction("Create bookmark");
        ...
        try {
            ...
            return McpSchema.CallToolResult.builder()
                .addTextContent(String.format("Successfully created bookmark at %s\nType: %s\nCategory: %s",
                    addr, type, category))
                .build();

        } catch (Exception e) {
            return McpSchema.CallToolResult.builder()
                .addTextContent("Failed to create bookmark: " + e.getMessage())
                .build();
        } finally {
